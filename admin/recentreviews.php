...
require_once('header.php'); ?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><strong>Recent Reviews</strong></li> 
		</ol>
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h4 class="panel-title">Recent Reviews</h4>
								...
								<table class="table table-striped table-bordered table-hover dataTables-example" id="producttable">
									...
									<tbody>
										...
										while($row = $stmt->fetch ())
										{
											...
											echo "<td><a id='editbtn".$r_id."' class='btn btn-info btn-xs' type='button' onclick='formsub(".$r_id.");'><form id='viewform".$r_id."' style='display: none' method='post' action='editreview.php'><input type='hidden' name='rid' value='".$r_id."'/><input type='hidden' name='page' value='recentreviews.php'/><input type='hidden' name='page_id' value='".$page_id."'/></form><i class='fa fa-edit'></i></a>&nbsp;<button id='deleteprobtn".$r_id."' class='btn btn-danger btn-xs' type='button' onclick='javascript: return deletepro(".$r_id.");'><i class='fa fa-trash-o'></i></button></td></tr>";
											$row_count++;
										}
										?>
									</tbody>
