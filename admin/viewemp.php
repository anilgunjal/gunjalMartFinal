...
require_once('header.php'); ?>
	 ...
	 <div class="main-content">
			<h1 class="page-title">List of Employee's</h1>
			<!-- Breadcrumb -->
					...
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							...
							<ul class="panel-tool-options"> 
								<li><a data-rel="collapse" href="viewemp.php#"><i class="icon-down-open"></i></a></li>
								<li><a data-rel="reload" href="viewemp.php#"><i class="icon-arrows-ccw"></i></a></li>
							</ul>
						</div>
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover dataTables-example" id="admintable">
									...
									<tbody>
										<?php
										$row_count = 1;
										$stmt = $mysqli->prepare("SELECT adminid, empid, name, contact, address, email, dob, avatar, status, empstat, logstatus, lastlogindate FROM admins WHERE status = '2';");
										$stmt->execute ();
...
{
	var x = confirm("Are you sure you want to Terminate this Staff?");
	if (x==true)
	{
		$.ajax({
			type:"POST",
			url: 'ajax/terminateemp.php',
			data:{'adminid':id},
