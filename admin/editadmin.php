...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><strong>Edit Admins</strong></li> 
		</ol>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h4 class="panel-title">Edit Admins Form</h4>
					...
					<div class="panel-body">
						<div id="successbox" class="alert alert-dismissable alert-success col-sm-offset-2" style="width:30%; display:none">
							<i class="ion-checkmark"></i>&nbsp; Admin Updated Successfully
		...
		$.ajax({
			...
			success: function(response){
				if(response == 1)
				{
					...
					setTimeout(function () {
						window.location.href='viewadmins.php';
					}, 3000);
				}
				else
				{
