...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><strong>View Employee Details</strong></li> 
		</ol>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						...
						<ul class="panel-tool-options"> 
							<li><a data-rel="collapse" href="empdetails.php#"><i class="icon-down-open"></i></a></li>
							<li><a data-rel="reload" href="empdetails.php#"><i class="icon-arrows-ccw"></i></a></li>
						</ul>
					</div>
