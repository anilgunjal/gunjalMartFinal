 ...
 require_once('header.php'); ?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><strong>All Reviews</strong></li> 
		</ol>
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h4 class="panel-title">All Reviews</h4>
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover dataTables-example" id="reviewtable">
									...
									<tbody>
										<?php
										$row_count = 1;
										$stmt = $mysqli->prepare("SELECT reviewstat.id, users.userid, users.username, reviewstat.store,reviewstat.comment,reviewstat.invoice,reviewstat.status,reviewstat.product_name,reviewstat.createdDate FROM reviewstat INNER JOIN users ON reviewstat.userid = users.userid ORDER BY reviewstat.id DESC");
										$stmt->execute ();
										$stmt->bind_result ( $r_id, $userid, $username, $store, $comments, $invoice, $status1, $product_name, $createdDate);
										$stmt->store_result ();
										while($row = $stmt->fetch ())
										{
											...
											echo "<td>";
												if($status1==0){ echo '<b>Pending</b>'; } elseif($status1==1) { echo '<b>Approved</b>'; } elseif($status1==2) { echo '<b>Approved(Review not Included)</b>'; } elseif($status1==3) { echo '<b>Second Review</b>'; } else { echo '<b>Rejected</b>';}
											echo "</td>";
