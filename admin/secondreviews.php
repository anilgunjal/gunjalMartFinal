...
require_once('header.php'); ?>
	...
	<div class="main-content">
		<h1 class="page-title">Second Reviews</h1>
		<!-- Breadcrumb -->
		<ol class="breadcrumb breadcrumb-2"> 
			<li><a href="index.php"><i class="fa fa-home"></i>Home</a></li>
			<li class="active"><a href="reviews.php">Reviews</a></li> 
			<li class="active"><strong>Second Reviews</strong></li> 
		</ol>
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							<h4 class="panel-title">Second Reviews</h4>
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover dataTables-example" id="reviewtable">
									...
									<tbody>
										<?php
										$row_count = 1;
										$stmt = $mysqli->prepare("SELECT reviewstat.id,reviewstat.product_name, users.userid, users.username, reviewstat.store,reviewstat.comment,reviewstat.invoice,reviewstat.status,reviewstat.second_review, reviewstat.createdDate FROM reviewstat INNER JOIN users ON reviewstat.userid = users.userid WHERE reviewstat.status = '3' ORDER BY reviewstat.id DESC;");
										$stmt->execute ();
										$stmt->bind_result ( $r_id, $product_name, $userid, $username, $store, $comments, $invoice, $status, $second_review, $createdDate);
										$stmt->store_result ();
